...
const SRC_FILE = path.resolve('src/sneaker_logic.js');
const OUT_FILE = path.resolve('db/changelogs/20_mle_wrapper.sql');
...
-- WARNING: DO NOT EDIT THIS FILE DIRECTLY. Edit src/sneaker_logic.js and run 'npm run build'
